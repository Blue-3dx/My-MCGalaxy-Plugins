...
namespace MCGalaxy {
	...
	public class DoorConfig {
		...
		public ushort  TEXTURE_BLOCK {get; set;}
	}
	public class Door : Plugin {
		public override string name { get { return "SomeTrapDoors"; } }
		public override string MCGalaxy_Version { get { return "1.9.1.2"; } }
		public override int build { get { return 100; } }
		public override string welcome { get { return "Loaded Message!"; } }
		public override string creator { get { return "Blue 3dx+Morgana's Code"; } }
		...
		public static ushort DoorBlockIdStorageIndex = 207; // Beggining of reserved Door slots will take up 8*Number of doors
		...
		public static List<DoorConfig> DoorConfigs = new List<DoorConfig>()
		{
			...
			{
				BLOCK_ITEM_ID = 234,
				BLOCK_ITEM_NAME = "Oak Trapdoor",
				TEXTURE_ITEM = 313, // Press F10 to see texture Ids
				TEXTURE_BLOCK = 313, // Press F10 to see texture Ids
			},
		};
		...
		public void AddDoorBlocks(DoorBlock door, string BLOCK_ITEM_NAME, ushort TEXTURE_ITEM, ushort TEXTURE_BLOCK, ushort TEXTURE_BLOCK_TOP)
		{
				AddBlockItem(door.Item_Block, BLOCK_ITEM_NAME, TEXTURE_ITEM);
				

				AddDoorBlock(door.Bottom_Block,		 		 0, 0, 0,   16, 4, 16, TEXTURE_BLOCK, TEXTURE_BLOCK, true);
				AddDoorBlock(door.Bottom_Block_Open, 		 0, 0, 0,   16, 16, 4, TEXTURE_BLOCK, TEXTURE_BLOCK, true);
				AddDoorBlock(door.Bottom_Block_Inverse,	 	 0, 0, 0,   16, 4, 16, TEXTURE_BLOCK, TEXTURE_BLOCK, true);
				AddDoorBlock(door.Bottom_Block_Inverse_Open, 0, 0, 0,   16, 16, 4, TEXTURE_BLOCK, TEXTURE_BLOCK, true);
		...
		public void LoadDoor(DoorConfig config)
		{
			...
			AddDoorBlocks(newDoor, config.BLOCK_ITEM_NAME, config.TEXTURE_ITEM, config.TEXTURE_BLOCK, config.TEXTURE_BLOCK_TOP);
		...
		public void OpenDoor(Level level, ushort x, ushort y, ushort z, bool mute = false)
		{
			...
			ushort result_bottom = (b == d.Bottom_Block_Inverse) ? d.Bottom_Block_Inverse_Open : d.Bottom_Block_Open;
		...
		public void CloseDoor(Level level, ushort x, ushort y, ushort z)
		{
			...
			ushort result_bottom = (b == d.Bottom_Block_Inverse_Open) ? d.Bottom_Block_Inverse : d.Bottom_Block;
			level.UpdateBlock(Player.Console, x, (ushort)(y + offset_y    ), z, result_bottom);
			PlaySound3D(level, x, y, z, "doorclose");
		}
		public bool IsOpen(Level level, DoorBlock d, BlockID b)
		{
			return (!(b == d.Bottom_Block ||b == d.Bottom_Block_Inverse));
		}
