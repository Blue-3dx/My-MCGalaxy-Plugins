...
/* 
    You will need to replace all "Blue" values with a random code.
	
	- To reward XP from an external plugin/command, use 'Command.Find("XP").Use(p, "Blue " + [player] + " [xp amount]");'
...
namespace MCGalaxy
{
    ...
    public sealed class CmdXP : Command2
    {
        ...
        /// <summary>
        /// Checks to see whether or not the player has leveled up.
        /// </summary>
        ...
        /// <summary>
        /// Checks to see whether or not the player has leveled down.
        /// </summary>
        ...
        public override void Use(Player p, string message, CommandData data)
        {
            ...
            if (args[0] == "Blue")
            {
                ...
                if (rows.Count == 0)
                {
                    ...
                    {
                        Command.Find("announce").Use(pl, "You Are Now Level " + newLevel);
                        Command.Find("trail").Use(pl, "xp");
                    }
